...
public class EventService {
    ...
    public static Optional<Event> findById(Long id) {
    ...
    public static List<Event> findAllPublished() {
        return eventRepo.findByStatus(EventStatus.PUBLISHED);
    }

    public static List<Event> findByCreator(Long userId) {
        return eventRepo.findByCreator(userId);
    }
