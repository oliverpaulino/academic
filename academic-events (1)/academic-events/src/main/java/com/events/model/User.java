...
public class User {
    ...
    public void setDeletable(boolean v)         { this.deletable = v; }
    ...
    public static final class Builder {
        ...
        public Builder deletable(boolean v) { this.deletable = v; return this; }

        public User build() {
            User u = new User();
            u.username = username; u.email = email; u.password = password;
            u.role = role; u.blocked = blocked; u.deletable = deletable;
            return u;
        }
    }
}
